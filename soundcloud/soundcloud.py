...
class SoundCloud:
    ...
    def __init__(self, client_id: str = None, auth_token: str = None, user_agent: str = DEFAULT_USER_AGENT) -> None:
        ...
        self.requests: Dict[str, Request] = {
            ...
            "search_albums": CollectionRequest[AlbumPlaylist](
                self, "/search/albums", AlbumPlaylist
            ),  # ?filter.genre_or_tag
            "search_playlists": CollectionRequest[AlbumPlaylist](
                self, "/search/playlists_without_albums", AlbumPlaylist
            ),
            "search_tracks": CollectionRequest[Track](
                self, "/search/tracks", Track
            ...
            "track_albums": CollectionRequest[BasicAlbumPlaylist](
                self, "/tracks/{track_id}/albums", BasicAlbumPlaylist
            ),  # (can be representation=mini)
            "track_playlists": CollectionRequest[BasicAlbumPlaylist](
                self, "/tracks/{track_id}/playlists_without_albums", BasicAlbumPlaylist
            ),  # (can be representation=mini)
            ...
            "user_conversation_messages": CollectionRequest[Message](
                self, "/users/{user_id}/conversations/{conversation_id}/messages", Message
            ),
            ...
            "user_conversations_unread": CollectionRequest[Conversation](
                self, "/users/{user_id}/conversations/unread", Conversation
            ),
            ...
            "user_albums": CollectionRequest[BasicAlbumPlaylist](
                self, "/users/{user_id}/albums", BasicAlbumPlaylist
            ),  # (can be representation=mini)
            "user_playlists": CollectionRequest[BasicAlbumPlaylist](
                self, "/users/{user_id}/playlists_without_albums", BasicAlbumPlaylist
            ),  # (can be representation=mini)
    ...
    def is_client_id_valid(self) -> bool:
        ...
        """
        try:
            next(self.requests["tag_recent_tracks"](tag="electronic", limit="1", use_auth=False))
            return True
    ...
    def get_tracks(
        self, track_ids: List[int], playlistId: int = None, playlistSecretToken: str = None, **kwargs
    ) -> List[BasicTrack]:
        """
    ...
    def get_track_comments(
        self, track_id: int, threaded: int = 0, filter_replies: int = 1, **kwargs
    ) -> Generator[BasicComment, None, None]:
        """
        Get comments on this track
        """
        return self.requests["track_comments"](
            track_id=track_id, threaded=threaded, filter_replies=filter_replies, **kwargs
        )
    ...
    def get_conversation_messages(self, user_id: int, conversation_id: int, **kwargs) -> Generator[Message, None, None]:
        ...
        """
        return self.requests["user_conversation_messages"](user_id=user_id, conversation_id=conversation_id, **kwargs)
...
class CollectionRequest(Request, Generic[T]):
    def __call__(self, use_auth=True, offset: str = None, limit: int = 10, **kwargs) -> Generator[T, None, None]:
        """
